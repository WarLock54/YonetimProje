                    ...
                    { "title": "Adres", "data": "Adres", "searchable": true },
                    {
                        ...
                        "render": function (data, type, row) {
                            const inner = `<a href="javascript:void(0);" class="chng-status" title="Durum" data-id="${row.Id
                                ...
                                <a href="/ETicaret/ESiparisIDList?siparid=${row.Id
                                }" class="on-default edit-row" title="Güncelle" data-id="${row.Id
                                }" style="margin-left: 5px;"><i class="fa fa-info"></i></a>

                                <a href="/ETicaret/ESipariGüncelle?id=${row.Id
                                }" class="on-default edit-row" title="Detay" data-id="${row.Id
                                }" style="margin-left: 5px;"><i class="fa fa-pencil"></i></a>

                                <a href="javascript:void(0);" class="delete-btn" title="Sil" data-id="${row.Id
                                }" style="margin-left: 5px;"><i class="fa fa-trash-o"></i></a>`;
                            return inner;
                        }
                    }
                ],
