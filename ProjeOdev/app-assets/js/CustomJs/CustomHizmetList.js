                ...
                "columns": [
                    ...
                    { "title": "Başlık", "data": "Baslik", "searchable": true },
                    {
                        ...
                        "render": function (data, type, row) {
                            const inner = `<a href="/Hizmet/HizmetlerEdit?id=${row.Id}" class="on-default edit-row" title="Güncelle" data-id="${row.Id
...
$('#datatable').on('click', '.delete-btn', function () {
    ...
    window.swal({
        ...
        .then((isConfirm) => {
            if (isConfirm) {
                window.location.href = `/Hizmet/HizmetlerDelete?id=${userid}`;
            } else {
