    ...
    assetListVM = {
        ...
        init: function () {
            window.dt = $('#datatable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": '/Bilgilendirme/GetBilgilendirme',
                    "data": function (data) {
                    }
                },
                "columns": [
                    ...
                    { "title": "Başlık", "data": "Baslik", "searchable": true },
                    {
                        ...
                        "render": function (data, type, row) {
                            const inner = `<a href="/Bilgilendirme/BilgilendirmeEdit?id=${row.Id}" class="on-default edit-row" title="Güncelle" data-id="${row.Id
...
$('#datatable').on('click', '.delete-btn', function () {
    ...
    window.swal({
        ...
        .then((isConfirm) => {
            if (isConfirm) {
                window.location.href = `/Bilgilendirme/BilgilendirmeDelete?id=${userid}`;
            } else {
